...
<div  class="editDIV">
    ...
    <div  class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <form method="post" action="/CRUDStudent?methodName=updateStu" role="form">
                <table class="editTable">
                    ...
                    <tr>
                        <td>姓名：</td>
                        <td><input type="text" name="name" id="name" value="${student.name}" placeholder="输入名字">
                        </td>
                    </tr>
                    <tr>
                        <td>性别：</td>
                    ...
                    <tr>
                        <td>成绩：</td>
                        <td><input type="text" name="score" id="score" value="${student.score}" placeholder="输入成绩"></td>
                    </tr>
                    <tr class="submitTR">
